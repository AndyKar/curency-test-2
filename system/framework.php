...
if ($config->get('db_autostart')) {
	...
	if(defined('DB2_DRIVER')){
		$registry->set('db2', new DB($config->get('db2_engine'), $config->get('db2_hostname'), $config->get('db2_username'), $config->get('db2_password'), $config->get('db2_database'), $config->get('db2_port')));
	}
}
